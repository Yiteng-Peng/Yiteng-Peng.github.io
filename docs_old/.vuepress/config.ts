...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "Yiteng Peng",
      description: 'Yiteng Peng\'s blogs',
    }
  },
  ...
  themeConfig: {
    ...
    repo: 'Yiteng-Peng/Yiteng-Peng.github.io', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'Yiteng Peng', // 必需
      link: 'https://github.com/Yiteng-Peng', // 可选的
    },
    ...
    social: {
      ...
      icons: [
        {
          iconClass: 'icon-tuite',
          title: 'X',
          link: 'https://x.com/YitengPeng',
        },
        {
        ...
        },
        {
          ...
          title: 'LinkedIn',
          link: 'https://www.linkedin.com/in/yiteng-peng/',
        },
      ],
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'Yiteng Peng', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
  ...
  head: [
    ['link', { rel: 'shortcut icon', href: '../assets/icons/favicon.png', type: "image/x-icon"}], //favicons，资源放在public文件夹
    [
      'meta',
      {
        name: 'keywords',
        content: 'Yiteng Peng, Blog, HKUST, USTC',
      },
    ],
